...
window.config={
    ...
    //报修
    person_repair:{
        url:url+name+'/weixin/wuye/index2.html?state=123#/butler?category=2',//报修
        fuwux:url+name+'/weixin/wuye/index2.html?state=123#/butler?category=0',//服务需求 
        butler:url+name+'/weixin/wuye/index2.html?state=123#/butler?category=1',//建议
    },
     //物业绑定房子
     house_domain: {
